                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td bgcolor="#ffffff" style="padding: 0px 40px 40px 40px; text-align: center; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                                        ...
                                        <br>Your campaign is ready for review.<br><br>You only have <strong>7 days</strong> to get at least <strong>25 pre-orders</strong>.
                                        Below you will find the button to launch your store.
                                        <br>
                                        <br>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto">
                                            <tbody>
                                                <tr>
                                                    <td class="button-td">
                                                        <a href="https://fandemic.co/"""+ID+"""/activate/now" style="background: #7BDC87; border: 15px solid #7BDC87; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#ffffff;">Launch Store</span>&nbsp;&nbsp;&nbsp;&nbsp;
                                                </a>
                                                    </td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="border-radius: 3px; text-align: center;">
                                                        <a href="https://fandemic.co/"""+ID+"""" style="font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: underline; display: block; border-radius: 3px; font-weight: bold;">
                                                            <span>View store before launching</span
                																</a>
                														</td>
                												</tr>
                										</tbody></table>
                										...
                										<br><hr><br>
                										If you want to change anything on the store please click the button below or respond to this email. <br> Thanks and Goodluck!
                										<br><br>

                										<table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto">
                												<tbody><tr>
                													<td style="border-radius: 3px; background: #800080; text-align: center;" >
                															<a href="mailto:sarah@fandemic.co?subject=Store Modification Request&body=Want modifications on your store? Please type them below:" style="background: #800080; border: 15px solid #800080; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
