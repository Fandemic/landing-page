...
class Mailer:
    ...
    def sendActivateStoreEmail(self,toaddr,ID,name):
                                        ...
                                        <tbody><tr>
                                                ...
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                                    <tbody><tr>
                                                        <td style="padding: 10px; text-align: center">
                                                                ...
                                                                <img src="https://fandemic.co/static/img/social_media/snapchat.png" width="80" height="80" alt="alt_text" border="0" class="fluid" style="margin-left:-20%;background: #dddddd; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                                            ...
                                            <td width="25%" class="stack-column-center">
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                                    ...
                                                    <tr>
                                                        <td style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                																					Make a great video showing off your store! Our most successful stars all do this. Take a look at our trending stores on the <a href="https://fandemic.co">homepage</a>!
                																				</td>
                                                    </tr>
                                                </tbody></table>
                                            </td>
        ...
        try:
            ...
            msg['From'] = fromaddr
            msg['To'] = ", ".join(toaddr)
            msg['Subject'] = "Your Campaign has Been Activated!"
            msg.attach(MIMEText(html, 'html'))
            server = smtplib.SMTP('smtp-relay.gmail.com', 587)
            server.starttls()
            server.login(fromaddr, "fandemic123")
    ...
    def sendActivate(self,toaddr,ID,name):
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
  ...
  <tbody>
    ...
    <!-- 1 Column Text : BEGIN -->
    <tr>
      <td bgcolor="#ffffff" style="padding: 0px 40px 40px 40px; text-align: center; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
        <h1>Your Store is Ready!</h1>
        <br>Your campaign is ready for review.
        <br>
        <br>You only have
        <strong>7 days</strong> to get at least
        <strong>10 pre-orders</strong>. Below you will find the buttons to review, alter and launch your store.
                  ...
                  <tbody>
                    <tr>
                      <td style="padding: 10px; text-align: center">
                        ...
                        <a href="https://fandemic.co/"""+ID+"""" style="background: #822f82;border: 15px solid #822f82;font-family: sans-serif;font-size: 13px;line-height: 1.1;text-align: center;text-decoration: none;display: block;border-radius: 3px;font-weight: bold;" class="button-a">
                                                          &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#ffffff;">View Store</span>&nbsp;&nbsp;&nbsp;&nbsp;
                                                                </a>
                      </td>
                    </tr>
                    <tr>
                      <td style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                        Check out your amazing beauty kit and review the store!
                      </td>
                    </tr>
                  </tbody>
                </table>
                  ...
                  <tbody>
                    <tr>
                      <td style="padding: 10px; text-align: center">
                        ...
                        <a href="mailto:sarah@fandemic.co?subject=Store Modification Request&amp;body=Want modifications on your store? Please type them below:" style="background: #822f82; border: 15px solid #822f82; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
                                                                                                                    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#ffffff;">Request Modifications</span>&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                                                          </a>
                      </td>
                    </tr>
                    <tr>
                      <td style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                        Want a new design or a general store modification? Let us know! Happy to help :)
                      </td>
                    </tr>
                  </tbody>
                </table>
...
<tr><td bgcolor="#ffffff" align="center" valign="top" style="padding: 10px;">
        <hr><table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
          <tbody>
            <tr>
                  ...
                  <tbody>
                    <tr>
                      <td style="padding: 10px; text-align: center">
                        ...
                        <a href="https://fandemic.co/"""+ID+"""/activate/now" style="background: #3fa44b; border: 15px solid #3fa44b; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
                                                                                                                    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#ffffff;">Activate Store</span>&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                                                          </a>
                      </td>
                    </tr>
                    <tr>
                      <td style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                        Ready to launch your store and promote? Let's do it!!
                      </td>
                    </tr>
                  </tbody>
                </table>
    ...
    <tr>
      <td height="40" style="font-size: 0; line-height: 0;">
        ...
        try:
            ...
            msg['From'] = fromaddr
            msg['To'] = ", ".join(toaddr)
            msg['Subject'] = "Your Beauty Store is Ready for Launch!"
            msg.attach(MIMEText(html, 'html'))
            server = smtplib.SMTP('smtp-relay.gmail.com', 587)
            server.starttls()
            server.login(fromaddr, "fandemic123")
